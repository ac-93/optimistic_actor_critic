...
def kl_policy(x, act_dim, hidden_sizes, activation):
    ...
    return mu, pi, action_probs, log_action_probs, logits
...
def mlp_actor_critic(x, a, hidden_sizes=[400,300], activation=tf.nn.relu, policy=kl_policy):
    ...
    with tf.variable_scope('pi'):
        mu, pi, action_probs, log_action_probs, action_logits = kl_policy(x, act_dim, hidden_sizes, activation)
    ...
    return mu, pi, action_probs, log_action_probs, action_logits, q1_logits, q2_logits
