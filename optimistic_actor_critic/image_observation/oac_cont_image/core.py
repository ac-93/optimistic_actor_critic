...
def build_models(x, a, act, act_dim, network_params):
    ...
    with tf.variable_scope('pi'):
        pretanh_mu, pretanh_pi, pretanh_logp_pi, std = gaussian_policy(x, act_dim, network_params)
        mu, pi, logp_pi = apply_squashing_func(pretanh_mu, pretanh_pi, pretanh_logp_pi)
    ...
    return mu, pi, logp_pi, q1, q2, pretanh_mu, std
